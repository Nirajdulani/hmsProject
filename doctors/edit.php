 ...
 <form method="post" action="<?= '../doctors/handle.php' ?>" class="bg-white rounded   p-4 px-4 md:p-8 mb-6 mx-64">
   <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
     <div class="text-gray-600">
       <h1 class="text-3xl font-bold">
         <?= ucfirst($mode) ?> Doctor <?= $id ?></h1>
     </div>
     ...
     <div class="lg:col-span-2">
       <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
         ...
         <div class="md:col-span-1">
           ...
           <input type="text" name="specialist" id="specialist" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="<?= isset($specialist) ? $specialist : '' ?>" placeholder="" />
         </div>
