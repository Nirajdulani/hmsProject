 ...
 <form method="post" action="<?= '../appointment/handle.php' ?>" class="bg-white rounded   p-4 px-4 md:p-8 mb-6 mx-64">
     ...
     <div class="lg:col-span-2">
       <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
         <div class="md:col-span-5">
           ...
           <input type="text" name="fullname" id="fullname" required class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="<?= isset($fullname) ? $fullname : '' ?>" />
         </div>
         ...
         <div class="md:col-span-5">
           ...
           <input type="text" name="age" id="age" required class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="<?= isset($age) ? $age : '' ?>" />
         </div>

         <div class="md:col-span-5">
           <label for="fullname">Date</label>
           <input type="date" name="joiningdate" required id="joiningdate" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="<?= isset($date) ? $date : '' ?>" />
         ...
         <div class="md:col-span-2">
           ...
           <input type="text" name="email" required id="email" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="<?= isset($email) ? $email : '' ?>" placeholder="email@domain.com" />
         </div>


         <div class="md:col-span-5">
           <label for="address">Address / Street</label>
           <textarea type="text" required name="address" id="address" class="  border mt-1 rounded px-4 w-full bg-gray-50" placeholder="" rows="5"><?= isset($address) ? $address : '' ?></textarea>
         </div>

         <div class="md:col-span-1">
           <label for="contact">Contact</label>
           <input type="text" required name="contact" id="contact" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="<?= isset($contact) ? $contact : '' ?>" placeholder="+91 9876543210" />
         </div>

         <div class="md:col-span-1">
           <label for="contact">Diseases</label>
           <input type="text"required name="diseases" id="diseases" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="<?= isset($diseases) ? $diseases : '' ?>" placeholder="" />
         </div>
